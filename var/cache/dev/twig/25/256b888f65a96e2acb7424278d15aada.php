...
class __TwigTemplate_40dcd84084f7299bfcaf70a0a2d51306 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <a href=\"{{ path('app_reservation_index') }}\">retour</a>
{% endblock %}
", "reservation/new.html.twig", "/app/templates/reservation/new.html.twig");
    }
}
