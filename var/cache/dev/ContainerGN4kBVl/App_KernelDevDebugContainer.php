...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\TypeFilterController' => 'getTypeFilterControllerService',
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('stripe_publishable_key', $this->getEnv('STRIPE_PUBLISHABLE_KEY'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'bien_img_directory' => (\dirname(__DIR__, 4).'/public/img'),
